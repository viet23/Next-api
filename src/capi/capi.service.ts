...
export class CapiService {
  ...
  async sendToMeta({ body, clientIp, userAgent }: { body: any; clientIp?: string; userAgent?: string }) {
    ...
    this.logger.debug(`⚙️ Using CAPI config: pixelId=${pixelId}, graphVer=${graphVer}, testCode=${testCode || 'N/A'}`)
