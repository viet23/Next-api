...
export class Plan1758034915908 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tbl_subscription_plans" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying NOT NULL, "price" integer NOT NULL DEFAULT '0', "features" jsonb, CONSTRAINT "PK_81078e9fe1d54eb9009c2e7824b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c21b74780c776285a59232fb2f" ON "tbl_subscription_plans" ("name") `);
        await queryRunner.query(`CREATE TABLE "tbl_user_subscriptions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, "isPaid" boolean NOT NULL DEFAULT false, "userId" uuid NOT NULL, "planId" uuid NOT NULL, CONSTRAINT "PK_7c293f1e28774a08208481a8c30" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tbl_user_subscriptions" ADD CONSTRAINT "FK_5fefb5e74415c4237d63942d72d" FOREIGN KEY ("userId") REFERENCES "tbl_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tbl_user_subscriptions" ADD CONSTRAINT "FK_09047bcb4e6da0212be19205f45" FOREIGN KEY ("planId") REFERENCES "tbl_subscription_plans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
