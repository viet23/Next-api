...
export class facebookAds1750852272229 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            `);
        await queryRunner.query(`ALTER TABLE "facebook_ads" ADD CONSTRAINT "FK_2f28601f065c01f176b7f4c8f8a" FOREIGN KEY ("created_by") REFERENCES "tbl_users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
