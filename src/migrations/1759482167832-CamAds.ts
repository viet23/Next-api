...
export class CamAds1759482167832 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "facebook_ads" ADD CONSTRAINT "FK_b24a17eed3b2dfe402e71607374" FOREIGN KEY ("campaign_id_ref") REFERENCES "facebook_campaigns"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "facebook_campaigns" ADD CONSTRAINT "FK_5dcee11d2fdaa91def31e3757cf" FOREIGN KEY ("created_by") REFERENCES "tbl_users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
