...
export class TokenInternal1760349898558 implements MigrationInterface {
  name = 'TokenInternal1760349898558'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "tbl_users" ADD "internal_user_access_token" character varying`)
    await queryRunner.query(`ALTER TABLE "tbl_users" ADD "internal_page_access_token" character varying`)
    await queryRunner.query(`ALTER TABLE "tbl_users" ADD "is_internal" boolean NOT NULL DEFAULT false`)
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "group_role" DROP CONSTRAINT "FK_e9d49994467a645560fce4bcca4"`)
    await queryRunner.query(`ALTER TABLE "group_role" DROP CONSTRAINT "FK_23e6ccf814c8fb5704dc35bda8d"`)
    await queryRunner.query(`ALTER TABLE "tbl_users" DROP COLUMN "is_internal"`)
    await queryRunner.query(`ALTER TABLE "tbl_users" DROP COLUMN "internal_page_access_token"`)
    await queryRunner.query(`ALTER TABLE "tbl_users" DROP COLUMN "internal_user_access_token"`)
    await queryRunner.query(
      `ALTER TABLE "group_user" ADD CONSTRAINT "FK_0837be536f0f518052a7bef2e04" FOREIGN KEY ("user_id") REFERENCES "tbl_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
