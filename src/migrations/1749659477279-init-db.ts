...
`)
    ...
    await queryRunner.query(
      `CREATE TABLE "group_role" ("role_id" uuid NOT NULL, "group_id" uuid NOT NULL, CONSTRAINT "PK_34b9a049ae09a85e87e7f18787b" PRIMARY KEY ("role_id", "group_id"))`,
    )
    ...
    await queryRunner.query(
      `CREATE TABLE "group_user" ("user_id" uuid NOT NULL, "group_id" uuid NOT NULL, CONSTRAINT "PK_8c8ce37e281754b6d2b50af9561" PRIMARY KEY ("user_id", "group_id"))`,
    )
